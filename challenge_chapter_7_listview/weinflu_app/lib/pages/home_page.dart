...
import 'package:weinflu_app/widgets/movement_list_container.dart';
import 'package:weinflu_app/config/app_routes.dart';

import '../widgets/home_app_bar_title.dart';
import '../widgets/movement_container.dart';
import '../widgets/product_detail.dart';
import '../widgets/product_recent_transaction.dart';
      ...
      children: [
        TextButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).pushReplacementNamed(AppRoutes.viewAll);
          },
        ),
